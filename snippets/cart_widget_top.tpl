<div id="cartWidgetTop" class="sliding-cart-widget">
    <button id="closeTriggerTop" class="cart-widget-trigger"><i class="icon icon-close"></i></button>
    <div class="container">

        <form id="minicartSummary" class="col-sm-12 {if $cart->item_count == 0} hidden{/if}" action="{reverse_url name=shop_cart}" method="post">
